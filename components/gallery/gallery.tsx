        ...
        <div className="columns-1 gap-4 md:columns-1 lg:columns-2">
          {gallery.artworks?.length > 0 &&
            gallery.artworks.map((artwork: ArtworkType, i: Key) => (
              <div
                key={i}
                className="mb-8 flex items-center justify-center bg-neutral-50 text-neutral-200 transition-colors hover:bg-neutral-100 hover:brightness-90 hover:text-neutral-300 cursor-pointer"
